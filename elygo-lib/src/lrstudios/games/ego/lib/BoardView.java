...
public final class BoardView extends SurfaceView implements SurfaceHolder.Callback
{
	...
	public boolean onTouchEvent(MotionEvent e)
	{
		switch (e.getAction())
		{
			...
			case MotionEvent.ACTION_UP: onUp(e); break;
		}
    ...
    public void onDraw(Canvas canvas)
    {
        ...
        for (BoardMark mark : board.getMarks())
		{
			...
			else
			{
				...
				switch (mark.type)
                {
					case BoardMark.MARK_CIRCLE:   markShape = _theme.circleMark;   break;
					case BoardMark.MARK_CROSS:    markShape = _theme.crossMark;    break;
					case BoardMark.MARK_SQUARE:   markShape = _theme.squareMark;   break;
					case BoardMark.MARK_TRIANGLE: markShape = _theme.triangleMark; break;
                }
